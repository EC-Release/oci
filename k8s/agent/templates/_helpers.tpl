...
- port: {{ ternary .Values.global.agtK8Config.svcPortNum .Values.agtK8Config.svcPortNum .Values.global.agtK8Config.svcPortNum }}
...
- port: {{ ternary .Values.global.agtK8Config.svcHealthPortNum .Values.agtK8Config.svcHealthPortNum .Values.global.agtK8Config.svcHealthPortNum }}
