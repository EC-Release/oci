...
yq w k8s/example/values.yaml "global.agtK8Config.withPlugins.tls.enabled" false
yq w k8s/example/values.yaml "global.agtK8Config.withPlugins.vln.enabled" true
yq w k8s/example/values.yaml "global.agtK8Config.withPlugins.vln.remote" false
helm template k8s/example --debug --set-file global.agtConfig=k8s/example/client+vln.env

printf "\n\n\n*** test client with remote vln template\n\n"
yq w k8s/example/values.yaml "global.agtK8Config.withPlugins.tls.enabled" false
yq w k8s/example/values.yaml "global.agtK8Config.withPlugins.vln.enabled" true
yq w k8s/example/values.yaml "global.agtK8Config.withPlugins.vln.remote" true
helm template k8s/example --debug --set-file global.agtConfig=k8s/example/client+vln.env
